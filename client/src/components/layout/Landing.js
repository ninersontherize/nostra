              ...
              <div className="col s6 landing-table-container">
                ...
                <table className="striped">
                  <tr key="row_1">
                    ...
                    <td>
                      <img className="landing-row1-img" src={process.env.PUBLIC_URL + "/lcs/c9_large.png"} />
                    </td>
                    <td>
                      <img className="landing-row1-img" src={process.env.PUBLIC_URL + "/lcs/clg_small.png"} />
                    </td>
                    <td>
                      <img className="landing-row1-img" src={process.env.PUBLIC_URL + "/lcs/liquid_large.png"} />
                    </td>
                  </tr>
                  <tr key="row_2">
